...
public class SubroutineHierarchy extends JPanel {
	...
	private void drawWorld(Graphics2D g2) {
		...
		rotatingPentagonCentre1(g2);
		rotatingPentagonCentre2(g2);
		rotatingPentagonLeft1(g2);
		rotatingPentagonLeft2(g2);
		rotatingPentagonRight1(g2);
		rotatingPentagonRight2(g2);
	...
	//private void centreTriangleVoid(Graphics2D g2) { // (DELETE THIS EXAMPLE)
	//	AffineTransform saveTransform = g2.getTransform();  // (It might be necessary to save/restore transform and color)
	//	g2.setTransform(saveTransform);
	//}


	private void rotatingPentagonCentre1(Graphics2D g2) { 
		AffineTransform saveTransform = g2.getTransform();  
		Color saveColor = g2.getColor();
		g2.setColor( Color.blue );
		g2.rotate( Math.toRadians( frameNumber*0.75 ));
		g2.scale(1,1);
		filledPentagonCentre1(g2);
		g2.setColor(saveColor);
		g2.setTransform(saveTransform);
	}

	private void rotatingPentagonCentre2(Graphics2D g2) { 
		AffineTransform saveTransform = g2.getTransform();  
		Color saveColor = g2.getColor();
		g2.setColor( Color.blue );
		g2.rotate( Math.toRadians( frameNumber*0.75 ));
		g2.scale(1,1);
		filledPentagonCentre2(g2);
		g2.setColor(saveColor);
		g2.setTransform(saveTransform);
	}

	private void rotatingPentagonLeft1(Graphics2D g2) { 
		AffineTransform saveTransform = g2.getTransform();  
		Color saveColor = g2.getColor();
		g2.setColor( Color.blue );
		g2.rotate( Math.toRadians( frameNumber*0.75 ));
		g2.scale(0.8,0.8);
		filledPentagonLeft1(g2);
		g2.setColor(saveColor);
		g2.setTransform(saveTransform);
	}


	private void rotatingPentagonLeft2(Graphics2D g2) { 
		AffineTransform saveTransform = g2.getTransform(); 
		Color saveColor = g2.getColor();
		g2.setColor( Color.blue );
		g2.rotate( Math.toRadians( frameNumber*0.75 ));
		g2.scale(0.8,0.8);
		filledPentagonLeft2(g2);
		g2.setColor(saveColor);
		g2.setTransform(saveTransform);
	}

	private void rotatingPentagonRight1(Graphics2D g2) { 
		AffineTransform saveTransform = g2.getTransform();  
		Color saveColor = g2.getColor();
		g2.setColor( Color.blue );
		g2.rotate( Math.toRadians( frameNumber*0.75 ));
		g2.scale(0.6,0.6);
		filledPentagonRight1(g2);
		g2.setColor(saveColor);
		g2.setTransform(saveTransform);
	}

	private void rotatingPentagonRight2(Graphics2D g2) { 
		AffineTransform saveTransform = g2.getTransform();  
		Color saveColor = g2.getColor();
		g2.setColor( Color.blue );
		g2.rotate( Math.toRadians( frameNumber*0.75 ));
		g2.scale(0.6,0.6);
		filledPentagonRight2(g2);
		g2.setColor(saveColor);
		g2.setTransform(saveTransform);
	}
	...
	private static void centreTriangle(Graphics2D g2) {
		Path2D path = new Path2D.Double();
		path.moveTo(-0.25,-3);
		path.lineTo(0.25,-3);
		path.lineTo(0,-1);
	...
	private static void leftTriangle(Graphics2D g2) {
		Path2D path = new Path2D.Double();
		path.moveTo(-4,1);
		path.lineTo(-3.5,1);
	...
	private static void rightTriangle(Graphics2D g2) {
		Path2D path = new Path2D.Double();
		path.moveTo(3.5,2);
		path.lineTo(4,2);
	...
	private static void centreRectangle(Graphics2D g2) {
		Path2D path = new Path2D.Double();
		path.moveTo(2,-1);
		path.lineTo(2,-1.3);
		path.lineTo(-2,-1.3);
		path.lineTo(-2,-1);
		path.closePath();
		g2.rotate(Math.toRadians(-15),0,-1.2);
		g2.scale(2, 2);	
		g2.setColor(Color.red);
		g2.fill(path);
	}

	private static void leftRectangle(Graphics2D g2) {
		Path2D path = new Path2D.Double();
		path.moveTo(-7.5,1.9);
		path.lineTo(-7.5,1.6);
		path.lineTo(-3.5,1.6);
		...
		path.closePath();
		g2.scale(0.8, 0.8);
		g2.rotate(Math.toRadians(-7.5),0,-1.2);
		g2.setColor(Color.red);
		g2.fill(path);	
	}

	private static void rightRectangle(Graphics2D g2) {
		Path2D path = new Path2D.Double();
		path.moveTo(5.1,5.5);
		path.lineTo(5.1,5.2);
		path.lineTo(1.1,5.2);
	...
	private static void filledPentagonCentre1(Graphics2D g2) {
		Path2D path = new Path2D.Double();
		path.moveTo(-1.2,0.1);
		path.lineTo(-0.7,-0.4);
	...
	private static void filledPentagonCentre2(Graphics2D g2) {
		Path2D path = new Path2D.Double();
		path.moveTo(1.3,-0.6);
		path.lineTo(1.8,-1.1);
	...
	private static void filledPentagonLeft1(Graphics2D g2) {
		Path2D path = new Path2D.Double();
		path.moveTo(-1.7,2.1);
		path.lineTo(-1.2,1.6);
	...
	private static void filledPentagonLeft2(Graphics2D g2) {
		Path2D path = new Path2D.Double();
		path.moveTo(-4,2.7);
		path.lineTo(-3.5,2.2);
	...
	private static void filledPentagonRight1(Graphics2D g2) {
		Path2D path = new Path2D.Double();
		path.moveTo(4.4,3.1);
		path.lineTo(3.9,2.6);
	...
	private static void filledPentagonRight2(Graphics2D g2) {
		Path2D path = new Path2D.Double();
		path.moveTo(1.8,3.7);
		path.lineTo(1.3,3.2);
